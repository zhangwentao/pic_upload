...
package com.renren.picUpload
{
	...
	class AsyncJPEGEncoder extends EventDispatcher
	{
		...
		private var haltTimes:uint;
		private var kuai:uint = 0;
		private var timem:Date = new Date();
		...
		private var YTable:Array = new Array(64, true);
		private var UVTable:Array = new Array(64, true);
		private var outputfDCTQuant:Array = new Array(64, true);
		private var fdtbl_Y:Array = new Array(64, true);
		private var fdtbl_UV:Array = new Array(64, true);
		private var sf:int;
		
		private const aasf:Array = [
			1.0, 1.387039845, 1.306562965, 1.175875602,
			1.0, 0.785694958, 0.541196100, 0.275899379
		];
		
		private var YQT:Array = [
		...
		private function computeHuffmanTbl(nrcodes:Array, std_table:Array):Array
		{
			...
			var HT:Array = new Array(251, true);
		...
		private var bitcode:Array = new Array(65535, true);
		private var category:Array = new Array(65535, true);
		...
		// Core processing
		internal var DU:Array = new Array(64, true);
		...
		private var YDU:Array = new Array(64, true);
		private var UDU:Array = new Array(64, true);
		private var VDU:Array = new Array(64, true);
		...
		private function loopEncode():void
		{
			...
			while (ypos<height)
			{
				...
				for (var xpos:int=0; xpos<width; xpos+=8)
				{
					...
					kuai++;
					//log("pointTime:  "+"x:"+ xpos+", y:"+ypos+" time:"+ (timem.getTime() - tt));
				}
				
				//next line
				ypos+=8;
				loopTime += getTimer() - time;
			    log((ypos/8)+"-lineTime:"+(getTimer()-time));
				if (isOvertime())
					return;
			}
			endEncode();
		...
		private function isOvertime():Boolean
		{
			if (loopTime > runTime)
			{
				loopTime=0;
		...
		{
			log("totalHaltTimes:" + (haltTimes * haltTime));
			log("kuai:" + kuai);
